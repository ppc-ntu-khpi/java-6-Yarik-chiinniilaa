# Практична робота: Робота з масивами (Java)

## Обране завдання
**Завдання №12:** Знайти рядок матриці розміром $N \times M$ з максимальною сумою елементів.

---

### 🛠️ Реалізація
В проєкті реалізовано два класи:
1.  **`MatrixProcessor`**: Містить статичний метод `findMaxSumRowIndex`. Обчислення суми елементів рядка реалізовано через `java.util.Arrays.stream`, що дозволило мінімізувати використання вкладених циклів.
2.  **`Main`**: Тестовий клас, що ініціалізує матрицю та виводить результат у консоль.
...
\end{pmatrix}
$$
Програма обчислить суми: $6, 60, 15$ і поверне індекс **1**.

### 📋 Вимоги виконано:
- [x] Код у теці `src`.
- [x] Використано клас `Arrays` для оптимізації.
- [x] Додано Javadoc коментарі.
- [x] Логіка відокремлена від інтерфейсу.




[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=23822609)
